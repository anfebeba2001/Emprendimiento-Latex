...
\label{proyeccion}
\includegraphics[width=0.9\textwidth]{Content/Images/AF/Proyeccion_de_ventas.png}
...
\label{ipc}
\includegraphics[width=0.9\textwidth]{Content/Images/AF/Proyeccion_de_incremento_ventas.png}
\footnote{Nota. \textup{Fuente : Autores.}}
\end{minipage}
